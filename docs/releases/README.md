...
| [v0.6.0](./v0.6.0.md) | Buyer Sales Orders and secure live synchronization |
...
The target release is `v0.7.1`. Structural parity has advanced for implemented surfaces; this does not claim full product migration or pixel-level parity with Vue.
