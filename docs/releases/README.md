...
| Release | Summary |
|---|---|
| [v0.4.0](./v0.4.0.md) | Buyer access and secured Catalog discovery |
...
The current release is `v0.4.0`. Evidence is limited to the validated Buyer access and Catalog slice; it does not claim full product migration or visual parity with Vue.
