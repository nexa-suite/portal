...
export default defineConfig({
  ...
  webServer: { command: 'npm run start -- --host 127.0.0.1 --port 4300 --proxy-config e2e/proxy.conf.json', url: 'http://127.0.0.1:4300', reuseExistingServer: !process.env.CI, timeout: 120_000 },
