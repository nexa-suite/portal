...
@Component({
  ...
  `,
  styles: [`:host{display:block}.page{display:grid;gap:1rem}.context{margin:0;color:#52647b}.links{display:flex;gap:1rem;flex-wrap:wrap}table{width:100%;border-collapse:collapse}th,td{padding:.65rem;text-align:left;border-bottom:1px solid #dbe3ee;vertical-align:top}.focused{background:#eef6ff}button{padding:.45rem .7rem}.result{padding:1rem;border:1px solid #b9d7f7;border-radius:.5rem;background:#f7fbff}.payment-element{min-height:6rem;padding:.8rem;border:1px solid #dbe3ee;border-radius:.5rem;background:#fff}.success{color:#0c6b41}`],
