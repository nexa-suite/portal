...
import { SalesOrderApiClient } from '../infrastructure/sales-order-api.client';
import { SalesOrder, SalesOrderEvent, SalesOrderPage } from '../domain/sales-order.models';
...
export class SalesOrderSelfServiceFacade {
  private readonly api = inject(SalesOrderApiClient);
