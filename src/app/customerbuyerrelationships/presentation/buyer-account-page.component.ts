...
import { BuyerAccountFacade } from '../application/buyer-account.facade';
import { addressDisplay, CreateClientAccountAddressInput, DeliveryAddressInput, ClientAccountAddress, directionsUrl, UpdateClientAccountAddressInput } from '../domain/buyer-account.models';
...
export class BuyerAccountPageComponent {
  ...
  readonly security = this.auth;
  readonly facade = inject(BuyerAccountFacade);
