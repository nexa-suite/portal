...
function fixture(profile: TenantProfile): MockDeliveryTrackingFixture {
  ...
  const deliveries: Delivery[] = [
    { id: `${profile}-delivery-001`, dispatchNumber: `DO-${key}-001`, salesOrderId: `${profile}-order-001`, salesOrderNumber: `SO-${key}-001`, clientAccountId: `client-${profile}-001`, status: 'DELIVERY_SCHEDULED', destination, deliveryWindowStart: '2026-08-27T09:00:00Z', deliveryWindowEnd: '2026-08-27T12:00:00Z', eta: '2026-08-27T10:30:00Z', podStatus: 'PENDING', version: 2, updatedAt: '2026-08-26T09:30:00Z', alerts: [] },
    { id: `${profile}-delivery-002`, dispatchNumber: `DO-${key}-002`, salesOrderId: `${profile}-order-002`, salesOrderNumber: `SO-${key}-002`, clientAccountId: `client-${profile}-001`, status: 'DELIVERED', destination: icisa ? 'Jr. de la Unión 500, Lima' : 'Av. Brasil 500, Lima', deliveryWindowStart: '2026-08-25T09:00:00Z', deliveryWindowEnd: '2026-08-25T12:00:00Z', eta: '2026-08-25T10:10:00Z', podStatus: 'COMPLETED', version: 3, updatedAt: '2026-08-25T11:10:00Z', alerts: [] },
  ];
  return {
    deliveries,
